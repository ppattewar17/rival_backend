...
let CommentsController = class CommentsController {
    ...
    createComment(blogId, createCommentDto, userId) {
        return this.commentsService.createComment(blogId, userId, createCommentDto);
    }
    getBlogComments(blogId, query) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a comment on a blog' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get comments for a blog' }),
    ...
    __metadata("design:returntype", void 0)
], CommentsController.prototype, "getBlogComments", null);
__decorate([
